...
public class Entity {
    ...
    public Integer attack(Entity enemy) {
        int damageDealt = (this.weapon.getDamage() * (this.charm != null ? this.charm.getAtq_bonus().intValue() : 1)) - enemy.getDefense();
    ...
    public void levelUp() {
        this.level += 1;
        this.health += 10;
        this.defense = (5* this.level) * (this.getCharm() == null ? 1 : this.getCharm().getDef_bonus());
        this.experience = 0;
